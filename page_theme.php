<?php
namespace Application\Theme\BaileyAndWalkil;
...
class PageTheme extends Theme implements ThemeProviderInterface
{
    ...
    {
        return t('Bailey and Walkil');
    }

    public function getThemeDescription()
    {
        return t('Bailey and Walkil Concrete Theme');
    }
    ...
    public function getThemeEditorClasses()
    {
        return [
            ...
            ['title' => t('Yellow Button'), 'menuClass' => '', 'spanClass' => 'yellow-button', 'forceBlock' => '-1'],
        ];
    }
